                    ...
                    @else
                        ...
                        @if (request('currency') != 'all')
                            ...
                            <div class="table-responsive mt-5">
                                <div class="p-4 bg-custom-gray2 shadow-md rounded-md">
                                    <table id="exchangesTable" class="table table-bordered mt-3"
                                        style="direction: rtl;">
                                        <thead>
                                            <tr class="text-center">
                                                <th class="text-center align-middle h-16 bg-black text-white ">الإجراءات
                                                </th>
                                                <th class="text-center align-middle h-16 bg-black text-white ">الموظف
                                                </th>
                                                <th class="text-center align-middle h-16 bg-black text-white ">رقم القيد
                                                </th>
                                                <th class="text-center align-middle h-16 bg-black text-white ">العملية
                                                </th>
                                                ...
                                                <th class="text-center align-middle h-16 bg-black text-white ">ملاحظة
                                                </th>
                                                    ...
                                                    <td>
                                                        @if ($exchange->user_id === auth()->id() || auth()->user()->hasRole('admin'))
                                                            ...
                                                            @if (auth()->user()->hasRole('admin'))
                                                                <button
                                                                    class="btn btn-sm btn-danger delete-exchange-btn"
                                                                    data-id="{{ $exchange->id }}">
                                                                    حذف
                                                                </button>
                                                            @endif
